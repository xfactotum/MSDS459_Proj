...
(function($){
function init(_1f5){
$(_1f5).addClass("tiptool-f");
};
function _1f6(_1f7){
var opts=$.data(_1f7,"tiptool").options;
$(_1f7)._unbind(".tiptool")._bind(opts.showEvent+".tiptool",function(e){
$(_1f7).tiptool("show",e);
})._bind(opts.hideEvent+".tiptool",function(e){
$(_1f7).tiptool("hide",e);
})._bind("mousemove.tiptool",function(e){
if(opts.trackMouse){
opts.trackMouseX=e.pageX;
opts.trackMouseY=e.pageY;
$(_1f7).tiptool("reposition");
}
});
};
function _1f8(_1f9){
var _1fa=$.data(_1f9,"tiptool");
if(_1fa.showTimer){
...
$(_1fc).tiptool("arrow").css("left",tip._outerWidth()/2+pos.left);
pos.left=0;
}
}else{
...
$(_1fc).tiptool("arrow").css("left",tip._outerWidth()/2-(pos.left-left));
}
}
}
}
...
tip.removeClass("tiptool-top tiptool-bottom tiptool-left tiptool-right").addClass("tiptool-"+opts.position);
var left,top;
...
var _204=$.data(_203,"tiptool");
var opts=_204.options;
var tip=_204.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"tiptool\">"+"<div class=\"tiptool-content\"></div>"+"<div class=\"tiptool-arrow-outer\"></div>"+"<div class=\"tiptool-arrow\"></div>"+"</div>").appendTo("body");
_204.tip=tip;
_205(_203);
}
_1f8(_203);
_204.showTimer=setTimeout(function(){
$(_203).tiptool("reposition");
tip.show();
opts.onShow.call(_203,e);
var _206=tip.children(".tiptool-arrow-outer");
var _207=tip.children(".tiptool-arrow");
...
_20d.tip.children(".tiptool-content").html(cc);
opts.onUpdate.call(_20b,cc);
};
function _20e(_20f){
var _210=$.data(_20f,"tiptool");
if(_210){
_1f8(_20f);
...
$.removeData(_20f,"tiptool");
$(_20f)._unbind(".tiptool").removeClass("tiptool-f");
opts.onDestroy.call(_20f);
}
};
$.fn.tiptool=function(_211,_212){
if(typeof _211=="string"){
return $.fn.tiptool.methods[_211](this,_212);
}
_211=_211||{};
return this.each(function(){
var _213=$.data(this,"tiptool");
if(_213){
$.extend(_213.options,_211);
}else{
$.data(this,"tiptool",{options:$.extend({},$.fn.tiptool.defaults,$.fn.tiptool.parseOptions(this),_211)});
init(this);
}
_1f6(this);
_205(this);
...
$.fn.tiptool.methods={options:function(jq){
return $.data(jq[0],"tiptool").options;
},tip:function(jq){
return $.data(jq[0],"tiptool").tip;
},arrow:function(jq){
return jq.tiptool("tip").children(".tiptool-arrow-outer,.tiptool-arrow");
},show:function(jq,e){
return jq.each(function(){
_202(this,e);
});
...
$.fn.tiptool.parseOptions=function(_215){
var t=$(_215);
...
$.fn.tiptool.defaults={position:"bottom",valign:"middle",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
_22d.find(".tiptool-f").each(function(){
$(this).tiptool("reposition");
});
...
t.find(".tiptool-f").each(function(){
...
_253.find(".tiptool-f").each(function(){
$(this).tiptool("hide");
});
_253.stop(true,true);
_253._size("unfit");
...
$(_4aa).tiptool({content:$("<div></div>"),position:opts.floatMenuPosition,valign:"top",data:data,onUpdate:function(_4ab){
var _4ac=$(this).tiptool("options");
var data=_4ac.data;
...
var t=$(this);
var tip=t.tiptool("tip").addClass("sidemenu-tiptool");
tip.children(".tiptool-content").addClass("sidemenu");
...
t.tiptool("reposition");
},onPosition:function(left,top){
var tip=$(this).tiptool("tip");
if(!opts.collapsed){
tip.css({left:-999999});
}else{
...
$(_4ae).find(".tiptool-f").each(function(){
var tip=$(this).tiptool("tip");
if(tip){
...
function _4c0(_4c1){
$(_4c1).find(".tiptool-f").each(function(){
$(this).tiptool("destroy");
});
$(_4c1).remove();
};
...
t.tiptool($.extend({},opts.tipOptions,{content:_59b,position:opts.tipPosition,deltaX:opts.deltaX,deltaY:opts.deltaY})).tiptool("show");
}
}
};
function _59e(_59f){
...
$(this).tiptool("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this).tiptool("destroy");
...
var _6ab=$(_6a3).find("[textboxName=\""+name+"\"],[esliderName=\""+name+"\"]");
if(_6ab.length){
...
$.fn.form.defaults={fieldTypes:["tagbox","combobox","combotree","combogrid","combotreegrid","datetimebox","datebox","timepicker","combo","datetimespinner","timespinner","numberspinner","spinner","eslider","searchbox","numberbox","passwordbox","filebox","textbox","switchbutton","radiobutton","checkbox"],novalidate:false,focusOnValidate:true,ajax:true,iframe:true,dirty:false,dirtyFields:[],url:null,queryParams:{},onSubmit:function(_6c5){
...
var builderdata=JSON.stringify(
          $('#builder').queryBuilder('getMongo'),
          undefined, 2
        );
var querystring='?page='+_992.page+'&rows='+_992.rows+'&sort='+_992.sort+'&order='+_992.order
$.ajax({type:opts.method,url:opts.url+querystring,data:builderdata,dataType:"json",success:function(data){
data = eval(data)[0];
_993(data);
},error:function(){
...
(function($){
function init(_d5d){
var _d5e=$("<div class=\"eslider\">"+"<div class=\"eslider-inner\">"+"<a href=\"javascript:;\" class=\"eslider-handle\"></a>"+"<span class=\"eslider-tip\"></span>"+"</div>"+"<div class=\"eslider-rule\"></div>"+"<div class=\"eslider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"eslider-value\">"+"</div>").insertAfter(_d5d);
var t=$(_d5d);
t.addClass("eslider-f").hide();
var name=t.attr("name");
if(name){
_d5e.find("input.eslider-value").attr("name",name);
t.removeAttr("name").attr("esliderName",name);
}
...
var _d63=$.data(_d61,"eslider");
var opts=_d63.options;
var _d64=_d63.eslider;
if(_d62){
if(_d62.width){
...
_d64.children("div.eslider-rule,div.eslider-rulelabel,div.eslider-inner")._outerHeight(_d64._outerHeight());
}
_d65(_d61);
};
function _d66(_d67){
var _d68=$.data(_d67,"eslider");
var opts=_d68.options;
var _d69=_d68.eslider;
...
_d6a(aa);
function _d6a(aa){
var rule=_d69.find("div.eslider-rule");
var _d6b=_d69.find("div.eslider-rulelabel");
rule.empty();
_d6b.empty();
for(var i=0;i<aa.length;i++){
...
function _d6d(_d6e){
var _d6f=$.data(_d6e,"eslider");
var opts=_d6f.options;
var _d70=_d6f.eslider;
_d70.removeClass("eslider-h eslider-v eslider-disabled");
_d70.addClass(opts.mode=="h"?"eslider-h":"eslider-v");
_d70.addClass(opts.disabled?"eslider-disabled":"");
var _d71=_d70.find(".eslider-inner");
_d71.html("<a href=\"javascript:;\" class=\"eslider-handle\"></a>"+"<span class=\"eslider-tip\"></span>");
if(opts.range){
_d71.append("<a href=\"javascript:;\" class=\"eslider-handle\"></a>"+"<span class=\"eslider-tip\"></span>");
}
_d70.find("a.eslider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_d70.find("div.eslider-inner")._unbind(".eslider")._bind("mousedown.eslider",function(e){
...
if(_d76){
var _d79=$(_d76).nextAll(".eslider-handle").length>0;
if(_d77<=v2&&_d79){
v1=_d77;
}else{
if(_d77>=v1&&(!_d79)){
...
$(_d6e).eslider("setValues",[v1,v2]);
}else{
$(_d6e).eslider("setValue",_d77);
}
};
};
function _d7a(_d7b,_d7c){
var _d7d=$.data(_d7b,"eslider");
var opts=_d7d.options;
var _d7e=_d7d.eslider;
...
_d7e.find(".eslider-value").remove();
var name=$(_d7b).attr("esliderName")||"";
...
var _d82=$("<input type=\"hidden\" class=\"eslider-value\">").appendTo(_d7e);
_d82.attr("name",name);
_d82.val(_d81);
_d80.push(_d81);
var _d83=_d7e.find(".eslider-handle:eq("+i+")");
var tip=_d83.next();
...
function _d65(_d86){
var opts=$.data(_d86,"eslider").options;
...
var _d89=$.data(_d87,"eslider");
var opts=_d89.options;
var _d8a=_d89.eslider;
...
var _d8c=$.data(_d8b,"eslider");
var opts=_d8c.options;
var _d8d=_d8c.eslider;
var size=opts.mode=="h"?_d8d.width():_d8d.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _d8e=opts.converter.toValue.call(_d8b,pos,size);
return _d8e;
};
$.fn.eslider=function(_d8f,_d90){
if(typeof _d8f=="string"){
return $.fn.eslider.methods[_d8f](this,_d90);
}
_d8f=_d8f||{};
return this.each(function(){
var _d91=$.data(this,"eslider");
if(_d91){
$.extend(_d91.options,_d8f);
}else{
_d91=$.data(this,"eslider",{options:$.extend({},$.fn.eslider.defaults,$.fn.eslider.parseOptions(this),_d8f),eslider:init(this)});
$(this)._propAttr("disabled",false);
}
...
return jq.each(function(){
var opts=$(this).eslider("options");
_d7a(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).eslider("options");
$(this).eslider(opts.range?"setValues":"setValue",opts.originalValue);
});
},enable:function(jq){
return jq.each(function(){
...
$.fn.eslider.parseOptions=function(_d95){
var t=$(_d95);
...
$.fn.eslider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_d96){
return _d96;
